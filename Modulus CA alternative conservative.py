...
CONSERVATISM = 0.9993  # Conservatism factor (adjust as needed, 1 = disabled)
...
# Create a fixed pattern for conservativism
pattern_size = (WIDTH // CELL_SIZE, HEIGHT // CELL_SIZE)
conservatism_pattern = np.ones(pattern_size, dtype=int) * CONSERVATISM
...
def apply_rules(grid):
    ...
    # Apply fixed pattern for conservativism
    return new_grid * conservatism_pattern
